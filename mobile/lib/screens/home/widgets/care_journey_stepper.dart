                    ...
                    SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(_stages[i].$2, maxLines: 1, overflow: TextOverflow.ellipsis, style: AppTextStyles.label.copyWith(fontSize: 11.5, color: done[i] ? AppColors.primaryText : AppColors.secondaryText, fontWeight: FontWeight.w700)),
                          Text(_stages[i].$3, maxLines: 1, overflow: TextOverflow.ellipsis, style: AppTextStyles.bodySm.copyWith(fontSize: 10, color: AppColors.secondaryText)),
                        ],
                      ),
                    ),
                ],
